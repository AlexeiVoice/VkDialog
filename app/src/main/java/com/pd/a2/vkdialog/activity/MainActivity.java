package com.pd.a2.vkdialog.activity;
...
import com.pd.a2.vkdialog.adapter.RecycleAdapter;
...
public class MainActivity extends AppCompatActivity implements OnFetchDataListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        vkWorker = new VKWorker();
        vkWorker.setOnFetchDataListener(this);
    ...
    @Override
    public void onDataFetched(ArrayList<MailItem> mailItemList) {
        setMailItemsList(mailItemList);
